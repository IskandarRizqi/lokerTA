<head>
	...
	<link class="skin" rel="stylesheet" type="text/css" href="{{asset('front/css/skin/skin-1.css')}}">
	<link rel="stylesheet" href="{{asset('front/plugins/datepicker/css/bootstrap-datetimepicker.min.css')}}" />
	<!-- Revolution Slider Css -->
	<link rel="stylesheet" type="text/css" href="{{asset('front/plugins/revolution/revolution/css/layers.css')}}">
