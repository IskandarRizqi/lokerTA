                        ...
                        <div class="widget-two">
                            ...
                            <div class="row m-2">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="idformal" value="">
                                    <input type="date" name="tanggalmulai" class="form-control @error('tanggalmulai') is-invalid @enderror" placeholder="DD-MM-YYYY" value="{{old('tanggalmulai')}}">
                                    @error('tanggalmulai')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row m-2">
                                ...
                                <div class="col-lg-6">
                                 ...
                                 <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="idformal" value="">
                                    <input type="int" name="IPK" class="form-control @error('IPK') is-invalid @enderror" placeholder="" value="{{old('IPK')}}">
                                    @error('IPK')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
