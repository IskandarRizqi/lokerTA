                        ...
                        <div class="widget-two">
                            ...
                            <div class="row m-1">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" name="facebook" class="form-control @error('facebook') is-invalid @enderror" placeholder="" value="{{old('facebook')}}">
                                    @error('facebook')
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="hidden" name="idsosiallink" value="">
                                    <input type="text" name="instagram" class="form-control @error('instagram') is-invalid @enderror" placeholder="" value="{{old('instagram')}}">
                                    @error('instagram')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="hidden" name="idsosiallink" value="">
                                    <input type="text" name="tiktok" class="form-control @error('tiktok') is-invalid @enderror" placeholder="" value="{{old('tiktok')}}">
                                    @error('tiktok')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="hidden" name="idsosiallink" value="">
                                    <input type="text" name="linkedin" class="form-control @error('linkedin') is-invalid @enderror" placeholder="" value="{{old('linkedin')}}">
                                    @error('linkedin')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-lg-12 mt-3 text-right"> <!-- Menggeser tombol ke kanan -->
                                ...
                                {{-- <a href="{{route('sosiallink.index')}}" class="btn btn-primary btn-sm">Kembali</a><!-- Tombol Create ditempatkan di sini --> --}}
