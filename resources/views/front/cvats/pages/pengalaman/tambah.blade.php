                        ...
                        <div class="widget-two">
                            ...
                            <div class="row m-2">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="hidden" name="idperusahaan" value="">
                                    <input type="text" name="kota" class="form-control @error('kota') is-invalid @enderror" placeholder="" value="{{old('kota')}}">
                                    @error('kota')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="hidden" name="idperusahaan" value="">
                                    <input type="text" name="negara" class="form-control @error('negara') is-invalid @enderror" placeholder="" value="{{old('negara')}}">
                                    @error('negara')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row m-2">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="idperusahaan" value="">
                                    <input type="date" name="tanggalmulai" class="form-control @error('tanggalmulai') is-invalid @enderror" placeholder="" value="{{old('tanggalmulai')}}">
                                    @error('tanggalmulai')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="idperusahaan" value="">
                                    <input type="date" name="tanggalselesai" class="form-control @error('tanggalselesai') is-invalid @enderror" placeholder="" value="{{old('tanggalselesai')}}">
                            ...
                            <div class="row m-1">
                                <div class="col-lg-12 text-left">
                                    <label for="form-control" style="color: black;">Ringkasan Tentang Pekerjaan Anda</label>
