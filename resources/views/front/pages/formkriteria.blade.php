...
<head>
    ...
    <style>
        body {
            ...
            padding: 20px;
            display: flex;
            justify-content: center; /* Mengatur kontainer ke tengah horizontal */
            align-items: center; /* Mengatur kontainer ke tengah vertikal */
            min-height: 100vh; /* Memastikan kontainer selalu memenuhi tinggi viewport */
        }
        ...
        .form-container {
            width: 400px; /* Atur lebar formulir */
            padding: 20px;
